...
/Users/leon/Documents/Specs/LXDataManager/0.7.0/LXDataManager.podspec
  s.description  = <<-DESC
  ...
  s.source       = { :git => "https://github.com/goodnighthsu/LXDataManager.git", :tag => "v0.7.0" }
